...
export default function WalletConnectModal() {
  ...
  return (
    <PopoverPanel className="absolute right-1/18 z-10 h-1/2 w-3/4 overflow-y-scroll rounded bg-stone-950/50 p-4 backdrop-blur-xl md:right-1/24 md:w-1/2 xl:w-1/3">
